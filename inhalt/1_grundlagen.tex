...
Not only in Computer Vision, such as object detection but also in natural language processing or speech recognition, and even human-level video game play deep neural networks are used to solve domain specific tasks. This chapter is about how those networks function this shall be achieved by explaining a certain neural network architecture, furthermore a glimpse is taken about tricks of the trade such as batch normalization and initialization.
