...
Every time a function in \gls{JS} is called, it is put on the call stack. The result of that function is popped out from stack. 
...
For executing concurrently JavaScript takes adavantage of the Web API, it calles the API with the function to be executed 
