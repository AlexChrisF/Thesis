...
If data needs to be aggregated from multiple child components it makes sense to lift all states up from the child to the parent, the parent then passes down the individual states for the child components. E.g. in a Tic Tac Toe game to determine who has won the game without aggregating the data the state of each
