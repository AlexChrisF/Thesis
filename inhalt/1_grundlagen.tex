...
squared error loss \(E = \sum{\frac{1}{2}*(target-y_{out})^2\)


Common costfunctions are mean squared error or crossentropy loss. The following subsection will get more into details.
