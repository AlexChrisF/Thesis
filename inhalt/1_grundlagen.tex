...
\section{JavaScript}
Today JavaScript is one of the most used programming language world wide.
...
Most modern web designs rely on a three-tier architecture (Fig. \ref{fig:ig:TT}). On the server side computing is done and data is stored in databases. The client fetches data from the server and makes it accessible. Often the user is able to change the data on the client side. 
