...
\begin{figure}[H]
	...
	\caption{Schematic view of a FCN. Schematic of a simple two layer fully connected neural network (FCN). The red marked units are the inputs. The blue marked units represent the hidden layer. The green units represent the output layer. Each arrow corresponds to a weight connecting the units} source:\cite{Component}
	\label{fig:COMPONENT}
\end{figure}
