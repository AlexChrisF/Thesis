...
Most modern web designs rely on a three-tier architecture. On the server side computing is done and data is stored in databases. The client fetches data from the server and makes it accessible. Often the user is able to change the data on the client side. 
