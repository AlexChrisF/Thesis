...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{bilder/grundlagen/uni.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{bilder/grundlagen/GameGrid.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth \textwidth]{bilder/grundlagen/VirtualDom.png}
