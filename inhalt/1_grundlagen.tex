...
A really common problem for neural networks is the classification of images or more general data, into a specific category. The best performing neural network architecture for classifying images are convolutional neural networks.
