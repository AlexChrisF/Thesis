...
The dispatcher can be considered as the central hub that is managing all data flows in a Flux application.
...
Stores contain the application's logic and sates.
