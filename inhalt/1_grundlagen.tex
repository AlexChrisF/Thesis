...
In recent years Computer Vision has changed from normal feature extraction to feature learning. With the increasing computational power it is now possible to teach algorithms and to recognize certain features in a picture. That is possible by enabling so called Neural Networks. A standard neural network (NN) consists of many simple, connected processors called neurons. 
