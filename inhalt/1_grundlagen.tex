...
Tensorlfow.js is a WebGL accelerated, browser bases JavaScript library for training and deploying Machine Learning models. It was first introduced in 2016. Since then it is the most famous JavaScript Framework for running Machine Learning algorithms. The GPU support provided by WebGL makes it possible to use Machine Learning algorithms is a suffice manner.
