...
All differential functions can be used as a activation function of a neural network. Common activation functions are. Most common functions are sigmoid,  \(f(z) = frac1 exp(-z)\)
