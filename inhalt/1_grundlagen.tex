...
In the convolutional layer several kernels are applied to extract spacial related features. The convolutions are stacked, there is one put on the stack for each on the input applied kernel.
