...
In short for each added component that needs access to the states a connector needs to be created and if not allready existing further actions and reducers need to be provided.

\subsection{Machine Learning API}
The machine learning API is build with Tensorflow.js 
