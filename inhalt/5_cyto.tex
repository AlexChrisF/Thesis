...
where \texttt{dataset} is an instance for handling the data, and \texttt{imageTags} are the HTML image tags. The API is using a CNN Network provided over a Content Delivery Network (CDN).
