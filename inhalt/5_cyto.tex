...
To explain the system structure we will walk through the process of adding a new component to the existing application. This component shall display a list of categories.
...
The  shall be fetched from a variable categories that is
