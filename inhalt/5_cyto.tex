...
First application needs to be downloaded:

\texttt{git clone https://github.com/cytoai/cyto.git}

Within the application foler following commands are used to
tun the app.
...
After that the local Node.js server can be created by:
