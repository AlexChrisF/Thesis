...
The following illustration shall give an overview of how responsibilities are distributed over the system.

classifier.js is the machine learning API it holds all functionality needed for machine learning and classifying tasks. The src folder contains all components, tests and Redux related files. To further explain the structure we will explain how to add a component in the next section.



\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{bilder/cyto/SystemArchitecture.png}
