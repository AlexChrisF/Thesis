...
\begin{figure}[H]
	...
	\caption{Pooling layer - Stacked convolutions can cause very large feature maps, making
the next convolution computationally intractable. Max pooling is a simple
and effective way to downsample the feature maps. Image reprinted from} source:\cite{Ratner2017}
	\label{fig:COMPONENT}
\end{figure}
