...
%\include{inhalt/1_architecture_and_technologies}
%\include{inhalt/2_deep_learning}
\include{inhalt/3_cells}
%\include{inhalt/4_related_work}
%\include{inhalt/5_cyto}
...
\bibliography{thesis}
% Einstellen des Bibliography-Stils für das 
